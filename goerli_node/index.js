...
const main = async (callbackFunction=()=>{}) => {
    ...
    const chainlinkToken = await connectChainlinkToken(goerliDetails.chainlinkTokenAddress, tokenABI, knownSigner)
    ...
    const chainlinkOracle = await setupChainlinkOracle(goerliDetails.chainlinkOracleAddress, oracleABI, knownSigner, nodeAddress)
...
const callbackFunction = async (store) => {
    ...
    const swipswapContract = await connectSwipswapContract(goerliDetails.swipswapAddress, swipswapABI, knownSigner)
    ...
    const swipTokenContract = await connectSWIPToken(goerliDetails.swipTokenContractAddress, swipTokenABI, knownSigner)
